...
public class PsychologistOutputDTO {
    ...
    public PsychologistOutputDTO(Psychologist psychologist){
        this(psychologist.getUsername(),psychologist.getEmail(), psychologist.getPassword(),psychologist.getPicture(), psychologist.getAddress(),psychologist.getCrp(), psychologist.getCnpj());
    }
}
